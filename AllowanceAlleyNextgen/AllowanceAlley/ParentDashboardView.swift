    ...
    private var quickActionsSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 12) {
                QuickActionButton(icon: "list.bullet.clipboard", title: "Add Chore", color: .blue) { showingAddChore = true }
                QuickActionButton(icon: "gift.fill", title: "Add Reward", color: .purple) { showingAddReward = true }
                QuickActionButton(icon: "person.badge.plus", title: "Add Child", color: .green) { showingAddChild = true }
                QuickActionButton(icon: "chart.bar.fill", title: "View Reports", color: .orange) { /* TODO */ }
            }
        }
    }
